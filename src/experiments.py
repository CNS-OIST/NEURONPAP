    ...
    def plotHeatmap(self, results, tag="", divedend=1, Kir=True, stdLabels=False):
        ...
        if stdLabels:
            self.setLabelColors(
                ...
                chanOverride={
                    "GluT": (
                        res[0].PAPGluTCount / self.PAPCount,
                        res[0].PAPGluTCount_std / self.PAPCount,
                    ),
                    "Kir": (
                        res[0].PAPKirCount / self.PAPCount,
                        res[0].PAPKirCount_std / self.PAPCount,
                    ),
                },
            )
